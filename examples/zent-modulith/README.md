...
Demonstrates **ZigModu** (Application / HTTP / **ComptimeRouter**) with **[zent](https://github.com/chy3xyz/zent)** v0.37.0 as the schema-as-code data layer (demos span v0.21–v0.37 capabilities).
...
`build.zig.zon` pins the released tag `v0.37.0`; for local development against a
