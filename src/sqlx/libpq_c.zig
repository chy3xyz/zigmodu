...
pub extern "c" fn PQgetlength(res: ?*const PGresult, row: c_int, col: c_int) c_int;
pub extern "c" fn PQfformat(res: ?*const PGresult, col: c_int) c_int;
pub extern "c" fn PQftype(res: ?*const PGresult, col: c_int) Oid;
