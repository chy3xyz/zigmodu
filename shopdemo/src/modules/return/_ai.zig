// ═══════════════════════════════════════════════════════════
// AI Context: return module
// ═══════════════════════════════════════════════════════════
// Dependencies: &.{}
// Tables:
//   zmodu_return_address — 10 columns
//
// Public API: service.zig
//   listZmoduReturnAddresss / getZmoduReturnAddress / createZmoduReturnAddress / updateZmoduReturnAddress / deleteZmoduReturnAddress
//
// Extension points:
