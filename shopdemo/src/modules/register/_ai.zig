// ═══════════════════════════════════════════════════════════
// AI Context: register module
// ═══════════════════════════════════════════════════════════
// Dependencies: &.{}
// Tables:
//   zmodu_register_record — 7 columns
//
// Public API: service.zig
//   listZmoduRegisterRecords / getZmoduRegisterRecord / createZmoduRegisterRecord / updateZmoduRegisterRecord / deleteZmoduRegisterRecord
//
// Extension points:
