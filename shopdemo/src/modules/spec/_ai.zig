// ═══════════════════════════════════════════════════════════
// AI Context: spec module
// ═══════════════════════════════════════════════════════════
// Dependencies: &.{}
// Tables:
//   zmodu_spec — 4 columns
//   zmodu_spec_value — 5 columns
//
// Public API: service.zig
//   listZmoduSpecs / getZmoduSpec / createZmoduSpec / updateZmoduSpec / deleteZmoduSpec
//   listZmoduSpecValues / getZmoduSpecValue / createZmoduSpecValue / updateZmoduSpecValue / deleteZmoduSpecValue
//
// Extension points:
