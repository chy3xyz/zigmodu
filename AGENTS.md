...
## Version
- Framework: **v0.15.32** (`build.zig.zon`)
...
- Package **v0.15.32** · Zig **0.17.0** · GitHub `chy3xyz/zigmodu` · branch `master`.
...
- zent v0.32.1 与 `data.sqlx` 正交，勿混驱动/共享事务（`docs/ZENT.md`）；`examples/zent-modulith` 按 v0.32.1 能力演示（v0.13 起向后兼容）。
